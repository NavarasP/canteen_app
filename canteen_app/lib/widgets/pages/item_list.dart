...
Widget _buildListItem(CanteenItem item) {
  return ListTile(
...
void _addToCart(CanteenItem item) async {
  // Fetch existing cart items
  List<CartItem> cartItems = await CartService.loadCartItems();

  // Check if the item is already in the cart
  int index = cartItems.indexWhere((cartItem) => cartItem.itemName == item.name);
